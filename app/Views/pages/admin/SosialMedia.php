                                ...
                                <tbody>
                                    <?php foreach ($all_data_SosialMedia as $tampilAktivitas) : ?>
                                        <tr>
                                            ...
                                            <img src="<?= base_url('assets/images/SosialMedia/') . $tampilAktivitas['image'] ?>" class="img-fluid" style="max-width: 100px; max-height: 100px; display: inline-block;" alt="image">
                                            </td>
                                            <td valign="middle">
