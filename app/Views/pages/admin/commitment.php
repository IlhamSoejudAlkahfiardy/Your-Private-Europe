    ...
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="<?php echo base_url() . "/tambahCommitment" ?>" class="btn btn-primary me-md-2"> + Tambah  </a>
            </div> 
        </div>
                    ...
                    <div class="app-card-body">
                        <div class="table-responsive">
                            ...
                            <table class="table app-table-hover mb-0 text-left">
                                ...
                                <tbody>
                                    <?php foreach ($all_data_commitment as $tampilAktivitas) : ?>
                                        <tr>
                                            ...
                                            <td class="center-text" style="text-align: center;">
                                                <img src="<?= base_url('assets/images/commitments/') . $tampilAktivitas['image'] ?>" class="img-fluid" style="max-width: 100px; max-height: 100px; display: inline-block;" alt="image">
                                            </td>

                                            <td style="text-align: center;"><?= $tampilAktivitas['alt_image'] ?></td>
                                            <td valign="middle">
                                                <div class="d-grid gap-2">
                                                    <a href="<?= base_url('/delete') . '/' . $tampilAktivitas['id'] ?>" class="btn btn-danger">Hapus</a>
                                                    <a href="<?= base_url('/editCommitment') . '/' . $tampilAktivitas['id'] ?>" class="btn btn-primary">Ubah</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
