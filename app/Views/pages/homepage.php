...
<div data-elementor-type="wp-page" data-elementor-id="234" class="elementor elementor-234">
                                    ...
                                    <div class="elementor-element elementor-element-15c7e1e elementor-widget elementor-widget-astrip_button" data-id="15c7e1e" data-element_type="widget" data-widget_type="astrip_button.default">
                                        <div class="elementor-widget-container">
                                            <div class="row justify-content-center">
                                                <div class="btn-align">
                                                    <a href="/<?= $language ?>/<?= $language == 'id' ? 'tentang-kami' : 'about-us' ?>" class="eg-btn btn--primary-outline btn--lg" style="background-color: #e0bc6d;" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'">
    ...
    <section style="margin-top: 50px !important;" class="elementor-section elementor-top-section elementor-element elementor-element-969e467 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="969e467" data-element_type="section">
        <div class="elementor-container elementor-column-gap-no">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                                                <div class="deal-single1">
                                                    ...
                                                    <div class="deal-content">
                                                        ...
                                                        <a href="/<?= $language ?>/<?= $language == 'id' ? 'destinasi' : 'destination' ?>/<?= $destination['slug'] ?>" class="eg-btn btn--primary-outline btn--md"><?= lang("text_homepage.trending_destination") ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Content End -->
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        <div class="elementor-element elementor-element-9b0a438 elementor-widget elementor-widget-astrip_button" data-id="9b0a438" data-element_type="widget" data-widget_type="astrip_button.default">
                                            <div class="elementor-widget-container">
                                                <div class="row justify-content-center">
                                                    <div class="btn-align">
                                                        <a href="/<?= $language ?>/<?= $language == 'id' ? 'destinasi' : 'destination' ?>" target="_blank" class="eg-btn btn--primary-outline btn--lg">
    ...
    <div class="blog-grid-section pt-50 pb-120">
        <div class="container">
