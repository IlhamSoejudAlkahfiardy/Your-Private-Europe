...
<div data-elementor-type="wp-page" data-elementor-id="234" class="elementor elementor-234">
    ...
    <section style="margin-top: 60px !important;" class="elementor-section elementor-top-section elementor-element elementor-element-969e467 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="969e467" data-element_type="section">
        <div class="elementor-container elementor-column-gap-default">
            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-0442f94" data-id="0442f94" data-element_type="column">
                <div class="elementor-widget-wrap elementor-element-populated">
                    <div class="elementor-element elementor-element-3062334 elementor-widget elementor-widget-astrip_heading" data-id="3062334" data-element_type="widget" data-widget_type="astrip_heading.default">
        ...
        <div class="elementor-container elementor-column-gap-no">
            <div style="width: 100% !important;" class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-1243d0f" data-id="1243d0f" data-element_type="column">
                <div class="elementor-widget-wrap elementor-element-populated">
                            ...
                            <div class="testimonial-section overflow-hidden">
                                <div class="container-fluid px-0">
                                    <div class="testimonial-wrapper">
                                        <div class="testimonial-area" style="min-height:100px !important;background: none !important;display: flex;justify-content: center;padding: 0px !important">
                                            ...
                                            <div class="testimonial-wrap" style="display: flex;justify-content: center;align-items: center;margin-left: 0px !important;">
                                                        ...
                                                        <?php foreach ($testimonials as $testimonial) : ?>
                                                            <div class="swiper-slide">
                                                                <div class="testimonial-single1">
                                                                    <div class="testimonial-content" style="border: 1px solid rgba(0,0,0,0.16)">
                                                                        <ul class="star-list">
                                                                    ...
                                                                    <div class="testi-author1">
                                                                        <div class="image" style="background-image: url(<?= base_url('assets/images/testimonials/') . $testimonial['image'] ?>);background-size: cover;background-position: center;border-radius: 50% !important;">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                                                <div class="deal-single1">
                                                    ...
                                                    <div class="deal-content">
                                                        ...
                                                        <!-- <a style="font-size: 16px; font-weight: 600;font-family: 'Oswald';" onmouseover="this.style.color='#086B7D';this.style.backgroundcolor='white'" onmouseout="this.style.color='white';this.style.backgroundcolor='#086B7D'" href="/<?= $language ?>/<?= $language == 'id' ? 'destinasi' : 'destination' ?>/<?= $destination['slug'] ?>" class="eg-btn btn--primary-outline btn--md"><?= lang("text_homepage.trending_destination") ?></a> -->
                                                        <div class="elementor-element elementor-element-15c7e1e elementor-widget elementor-widget-astrip_button" data-id="15c7e1e" data-element_type="widget" data-widget_type="astrip_button.default">
                                                            <div class="elementor-widget-container">
                                                                <div class="row justify-content-center">
                                                                    <div class="btn-align d-flex justify-content-center">
                                                                        <a aria-hidden="true" href="/<?= $language ?>/<?= $language == 'id' ? 'destinasi' : 'destination' ?>/<?= $destination['slug'] ?>" class="eg-btn btn--primary-outline " style="background-color: #e0bc6d;font-family: 'Oswald';padding:10px 35px;" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'">
                                    ...
                                    <div class="elementor-widget-wrap elementor-element-populated">
                                        ...
                                        <div class="elementor-element elementor-element-15c7e1e elementor-widget elementor-widget-astrip_button" data-id="15c7e1e" data-element_type="widget" data-widget_type="astrip_button.default">
                                            <div class="elementor-widget-container">
                                                <div class="row justify-content-center">
                                                    <div class="btn-align d-flex justify-content-center">
                                                        <a aria-hidden="true" href="/<?= $language ?>/<?= $language == 'id' ? 'destinasi' : 'destination' ?>" class="eg-btn btn--primary-outline btn--lg" style="background-color: #e0bc6d;font-family: 'Oswald';" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'">
                        ...
                        <div class="elementor-widget-container">
                            <div class="row justify-content-center">
                                <div class="btn-align d-flex justify-content-center" style="color: white;">
                                    <a aria-hidden="true" href="/<?= $language ?>/faq" class="eg-btn btn--primary btn--lg" style="background-color: #e0bc6d;font-family: 'Oswald';" onmouseover="this.style.color='#e0bc6d'" onmouseout="this.style.color='white'">
