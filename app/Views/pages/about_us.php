    ...
    <article aria-label="article" id="post-24" class="post-24 page type-page status-publish hentry">
        <div class="inner-post">
            <div data-elementor-type="wp-page" data-elementor-id="24" class="elementor elementor-24 ">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-lg-6 ps-lg-5">
                                                    <div class="about3-title text-start" style="padding-right: 0px !important;">
                                                        <p style="font-family:'Open Sans';font-size: 19px;font-weight: 600;color:#086B7D;"><?= $language == 'id' ? $aboutUs['section_id'] : $aboutUs['section_en'] ?></p>
                                                        <p style="font-family:'Open Sans';font-size: 34px;font-weight: 600;"><?= $language == 'id' ? $aboutUs['title_id'] : $aboutUs['title_en'] ?></p>
                                                    ...
                                                    <div class="btn-align">
                                                        <a style="font-family: 'Open Sans';" class="eg-btn btn--primary3-outline sibling-2 btn--lg" href="/<?= $language ?>/<?= $language == 'id' ? 'hubungi-kami' : 'contact-us' ?>">
                ...
                <section style="margin-top: 100px !important;margin-bottom: 100px !important;" class="elementor-section elementor-top-section elementor-element elementor-element-d1338d8 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="d1338d8" data-element_type="section">
                    <div class="elementor-container elementor-column-gap-default">
                                                    ...
                                                    <div class="col-xl-4 col-lg-3 col-md-4 col-sm-6 col-10">
                                                        <div class="counter-single text-center d-flex flex-column hover-border1">
                                                            ...
                                                            <div class="coundown d-flex flex-column">
                                                                ...
                                                                <p style="font-family: 'Open Sans';font-size: 18px;color:black" >
                                    ...
                                    <div class="elementor-widget-container">
                                        ...
                                        <div class=" justify-content-center">
                                            <div class="section-title1">
                                                <span style="color:#086B7D !important;font-weight: 700;letter-spacing: 0px !important;font-size: 19px !important;font-family: 'Open Sans' !important;">
                                                    <?= $language == 'id' ? $aboutUs['section_message_id'] : $aboutUs['section_message_en'] ?>
                                                </span>
                                                <h2 style="font-size: 30px;font-family: 'Open Sans';">
                                                    <?= $language == 'id' ? $aboutUs['title_message_id'] : $aboutUs['title_message_en'] ?>
                                                </h2>

                                            </div>
                                        </div>
                                        <div class="feature-section2 " style="margin: 60px 0px;">
                                            <div class="row justify-content-center">
                                                <div class="col-lg-5" style="margin-bottom: 30px;">
                                                    <div class="feature-image-group d-flex flex-row justify-content-center gap-5">
                                                        <div class=" translate-y">
                                                            <img decoding="async" src="<?= base_url('assets/images/founder/Chris.jpg') ?>" class="img-fluid" alt="feature-image-one">
                                                        </div>
                                                    </div>
                                                    <div style="display: flex;flex-direction: column;align-items: center;margin-top: 50px;">
                                                        <p style="font-family: 'Open Sans';color:black;margin:0px;font-size: 21px;font-weight: bold;"> <?= $aboutUs['name'] ?></p>
                                                        <p style="font-family: 'Open Sans';color:black;margin:0px;font-size: 17px;"> <?= $aboutUs['founder'] ?></p>
