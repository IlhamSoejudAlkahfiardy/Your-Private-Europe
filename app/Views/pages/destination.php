            ...
            <?php foreach ($destinations as $destination) : ?>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="best-plan-single1">
                        <div class="image">
                            <img width="425" height="345" src="<?= base_url('assets/images/destinations/') . $destination['image'] ?>" class="attachment-egns-img-one size-egns-img-one wp-post-image" alt="" decoding="async" loading="lazy" />
                        </div>
                        <div class="content">
