        ...
        <div class="row justify-content-center">
            <div class="col-xl-8 col-md-10 col-sm-12">
                <div class="breadcrumb-area">
                    ...
                    <h2>
                        <?= lang('text_other_services.heading') ?>
                    </h2>
                        ...
                        <div class="justify-content-center">
                            <div class="section-title1">
                                <span style="color:#086B7D !important;font-weight: 700;letter-spacing: 0px !important;">
                                    <?= $language == 'id' ? $otherServices[0]['section_id'] : $otherServices[0]['section_en'] ?>
                                </span>
                                <h3 style="font-size: 30px; font-weight: bold;margin-bottom: 15px !important;">
                                    <?= $language == 'id' ? $otherServices[0]['section_title_id'] : $otherServices[0]['section_title_en'] ?>
                                </h3>
