...
<div class="page-wrapper sec-mar">
    <article aria-label="article" id="post-30" class="post-30 page type-page status-publish hentry">
            ...
            <div data-elementor-type="wp-page" data-elementor-id="30" class="elementor elementor-30">
                <section class="elementor-section elementor-top-section elementor-element elementor-element-e2c78fd elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="e2c78fd" data-element_type="section">
                    <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-column elementor-col-66 elementor-top-column elementor-element elementor-element-b17fe2a" data-id="b17fe2a" data-element_type="column">
                            <div class="elementor-widget-wrap elementor-element-populated">
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="heading0">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse0" aria-expanded="true" aria-controls="collapse0">
                                                            01. What’s it like your job, grab a backpack, and travel the world? </button>
                                                    </h2>
                                                    <div id="collapse0" class="accordion-collapse collapse" aria-labelledby="heading0" data-bs-parent="#accordionExample">
                                                        <div class="accordion-body">
                                                            <p>Donec scelerisque ut tellus at congue. Aenean viverra tincidunt velit, nec commodo Donec quis tellus eros. Nunc faucibus leo et pellentesque porta. Integer placerat ur molestie volutpat. Maecenas rutrum urna faucibus auctor hendrerit. Suspendisse si venenatis, venenatis nisi vel, malesuada justo. Vestibulum ultrices diam nibh, sit amlacus ornare a adonil gornara fitana.</p>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="heading1">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                                            02. Vivamus gravida sapien ut gravida volutpat Sed? </button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="heading2">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2">
                                                            03. If I visit your country, what’s the one meal I shouldn’t miss? </button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="heading3">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="true" aria-controls="collapse3">
                                                            04. What are the most beautiful beaches in the world? </button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="heading4">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="true" aria-controls="collapse4">
                                                            05. Who’s the most interesting person you’ve ever met on a plane? </button>
                                                    </h2>
                                ...
                                <div class="elementor-element elementor-element-46096ca elementor-widget elementor-widget-astrip_heading" data-id="46096ca" data-element_type="widget" data-widget_type="astrip_heading.default">
                                    <div class="elementor-widget-container">


                                        <div class=" justify-content-center">
                                            <div class="section-title1">
                                                <span>This is your heading subtitle</span>
                                                <h2>This is your heading main title</h2>
                                ...
                                <div class="elementor-element elementor-element-3d06f21 elementor-widget elementor-widget-shortcode" data-id="3d06f21" data-element_type="widget" data-widget_type="shortcode.default">
                                    <div class="elementor-widget-container">
                                        <div class="elementor-shortcode">
                                            <div class="wpcf7 no-js" id="wpcf7-f1862-p30-o1" lang="en-US" dir="ltr">
                                                <div class="screen-reader-response">
                                                    <p role="status" aria-live="polite" aria-atomic="true"></p>
                                                    <ul></ul>
                                                </div>
                                                <form action="/questions-answers/#wpcf7-f1862-p30-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                                                    <div style="display: none;">
                                                        <input type="hidden" name="_wpcf7" value="1862">
                                                        <input type="hidden" name="_wpcf7_version" value="5.8.4">
                                                        <input type="hidden" name="_wpcf7_locale" value="en_US">
                                                        <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1862-p30-o1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-inner">
                                                                    <p><span class="wpcf7-form-control-wrap" data-name="name23"><input size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Your Name:" value="" type="text" name="name23"></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="form-inner">
                                                                    <p><span class="wpcf7-form-control-wrap" data-name="question"><textarea cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Write Your Question" name="question"></textarea></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                        ...
                        <div class="elementor-column elementor-col-33 elementor-top-column elementor-element elementor-element-f9b0649" data-id="f9b0649" data-element_type="column" data-settings="{" background_background":"classic"}"="">
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <div class="elementor-element elementor-element-bbda749 elementor-widget elementor-widget-egens_newsletter" data-id="bbda749" data-element_type="widget" data-widget_type="egens_newsletter.default">
                                    <div class="elementor-widget-container" style="background-image: url(<?= base_url('assets/images/side-newsletter.png') ?>);">
                                        ...
                                        <div class="newsletter-area">
                                            <div class="banner-form-box">
                                                ...
                                                <form class="newsletter-form">
                                                    ...
                                                    </div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off"></label><input type="hidden" name="_mc4wp_timestamp" value="1710987813"><input type="hidden" name="_mc4wp_form_id" value="115"><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1">
                                ...
                                <div class="elementor-element elementor-element-1d25b21 elementor-widget elementor-widget-image" data-id="1d25b21" data-element_type="widget" id="sidebanner" data-widget_type="image.default">
                                    <div class="elementor-widget-container">
                                        <style>
                ...
                <section class="elementor-section elementor-top-section elementor-element elementor-element-25c117c elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="25c117c" data-element_type="section">
                    <div class="elementor-container elementor-column-gap-no">
                        <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-edc5549" data-id="edc5549" data-element_type="column">
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <div class="elementor-element elementor-element-d17564b elementor-widget elementor-widget-egens_instagram_feed" data-id="d17564b" data-element_type="widget" data-widget_type="egens_instagram_feed.default">
                                    <div class="elementor-widget-container">
                                    </div>
                                </div>
                            </div>
