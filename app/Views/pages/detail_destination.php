                                ...
                                <figure class="wp-block-gallery has-nested-images columns-default is-cropped wp-block-gallery-1 is-layout-flex wp-block-gallery-is-layout-flex">
                                    ...
                                    <?php foreach ($imagesDescriptionDestinations as $imagesDescriprionDestination) : ?>
                                        <figure class="wp-block-image size-large">
                                            <img fetchpriority="high" decoding="async" width="319" height="300" data-id="1665" src="<?= base_url('assets/images/destinations/' . $imagesDescriprionDestination['url']) ?>" alt="" class="wp-image-1665" sizes=" (max-width: 319px) 100vw, 319px" />
                                        </figure>
                                    <?php endforeach; ?>
                                </figure>
