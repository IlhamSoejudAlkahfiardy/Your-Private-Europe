    ...
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="<?= base_url() . "admin/usp/tambah" ?>" class="btn btn-primary me-md-2"> + Tambah USP </a>
            </div>
        </div><!--//row-->
                            ...
                            <table class="table app-table-hover mb-0 text-left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('admin/usp/edit') . '/' . $usp['id'] ?>" class="btn btn-primary">Edit</a>
                                        <a href="<?= base_url('admin/usp/delete') . '/' . $usp['id'] ?>" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
