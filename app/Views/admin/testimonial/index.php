    ...
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="<?= base_url() . "admin/testimonial/tambah" ?>" class="btn btn-primary me-md-2"> + Tambah Testimonial </a>
            </div>
        </div><!--//row-->
                        ...
                        <div class="table-responsive">
                            <table class="table app-table-hover mb-0 text-left">
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?= base_url() . 'asset-user/images/' . $test['image'] ?>" class="img-fluid" alt="Foto Testimonial"></td>
                                    <td><?= $test['alt_image'] ?></td>
                                    <td>
                                        <!-- Adjust the edit and delete links accordingly -->
                                        <a href="<?= base_url('admin/testimonial/edit') . '/' . $test['id'] ?>" class="btn btn-primary">Edit</a>
                                        <a href="<?= base_url('admin/testimonial/delete') . '/' . $test['id'] ?>" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                </tbody>
