    ...
    <div class="container-xl">
        ...
        <div class="row g-4 settings-section">
            <div class="app-card app-card-settings shadow-sm p-4">
                ...
                <form action="<?= base_url('admin/testimonial/proses_edit/' . $testData['id']) ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <?php if(isset($testData['image'])): ?>
                            <img width="150px" class="img-thumbnail" src="<?= base_url() . "asset-user/images/" . $testData['image'] ?>">
                        <?php endif; ?>
